...
/**
 * Test class for IMatch.
 * Generated by PHPUnit on 2011-12-13 at 12:37:28.
 */
class IMatchTest extends \PHPUnit_Framework_TestCase
{

	/**
	 * @var gordian\reefknot\input\validate\prop\IMatch
	 */
	protected $object;
	...
	{
		$this -> object = new IMatch (array ('needle' => 'ThE qUiCk BrOwN fOx JuMpS oVeR tHe LaZy DoG.'));
	}
	...
	public function testIsValidInHaystackPasses ()
	{
		...
		$this -> assertTrue ($this -> object -> isValid ());
		$this -> object -> setData ('In et sem arcu, bibendum porttitor augue. Sed vitae diam mattis elit euismod vulputate. Fusce non nibh erat; a porta felis? Morbi suscipit rhoncus sagittis. Phasellus dui quam, vestibulum non sagittis non, posuere quis sem? Nullam non est nisl. Suspendisse potenti. Donec laoreet, augue vitae suscipit ornare, justo tellus fringilla felis, ac lacinia leo tellus quis magna. Nullam fermentum, nisi ut ultrices lacinia, urna mi faucibus sapien, sit amet semper ante diam a nisl. Phasellus pharetra odio ac magna euismod vestibulum. Nam fringilla neque sit amet ligula aliquet ac molestie nulla vulputate. Cras faucibus dignissim sem eget adipiscing. Nulla vehicula, est ut elementum sodales, massa enim rhoncus tortor, vitae pharetra lacus nisi vel nulla. Mauris fermentum dui id leo tincidunt rutrum. Curabitur rhoncus commodo tellus nec dignissim. THE QUICK BROWN FOX JUMPS OVER THE LAZY DOG. Vivamus ornare dapibus ultricies. Ut quis tellus enim. Quisque mauris felis, tempus ullamcorper commodo non; elementum nec arcu. Ut nisl libero, ornare sed ornare eu, lobortis id sapien. In sollicitudin tortor feugiat erat iaculis vel molestie libero molestie! Praesent malesuada, nunc quis sagittis elementum, odio risus facilisis diam, ac pharetra magna tortor vitae orci? Ut volutpat malesuada laoreet. Sed volutpat, lacus at iaculis ullamcorper; elit nisi ultrices dolor, et vestibulum justo elit in turpis. ');
		$this -> assertTrue ($this -> object -> isValid ());
	}
