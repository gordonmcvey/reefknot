...
/**
 * Test class for BasicValidatable.
 * Generated by PHPUnit on 2011-12-17 at 18:10:35.
 */
class BasicValidatableTest extends \PHPUnit_Framework_TestCase
{

	/**
	 * @var BasicValidatable
	 */
	protected $object;
	...
	{
		// Mock a concrete version of the abstract class
		$this -> object = $this -> getMockForAbstractClass ('gordian\reefknot\input\validate\abstr\BasicValidatable');
	}
	...
	{
		$testField	= new validate\Field (new validate\type\IsString ());
